...
angular.module('tailorApp')
  .controller('BuyFabricCtrl', function ($rootScope, $scope, $state, $stateParams, toaster, customShopService, commonService, upyun, rfc4122, localStorageService, tailoringTypes, CURRENCY, FABRIC_UNIT, payment, SETTLEMENT_TYPE) {

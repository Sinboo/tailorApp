...
angular.module('tailorApp')
  .controller('FactoryMyCustomShopsCtrl', function ($scope, localStorageService, $stateParams, factoryService, baseService, newApplyCount, PAGE_SIZE, SHOP_TYPE) {
    ...
    factoryService.getAllPartners(queryParams).then(function(data){
    ...
    $scope.quickQuery = function (shopKeywords) {
      ...
      factoryService.searchPartner(shopKeywords).then(function (data) {
        $scope.d = data.data[0];
      })
    };
